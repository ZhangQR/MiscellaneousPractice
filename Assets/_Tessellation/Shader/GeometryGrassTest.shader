Shader "URPPractice/GrassTest"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            geometryOutput CreateGeoOutput(float3 pos,float2 uv,half3 color)// 用于空间转换的函数
            {
                geometryOutput o;
                o.pos = UnityObjectToClipPos(pos);
                o.uv = uv;
            ...
            void geo(triangle vertexOutput IN[3] : SV_POSITION, inout TriangleStream<geometryOutput> triStream)
            {
                ...
                triStream.Append(CreateGeoOutput(IN[0].vertex,float2(0,0),half3(1,0,0)));
                triStream.Append(CreateGeoOutput(IN[1].vertex,float2(0,0),half3(0,1,0)));
                triStream.Append(CreateGeoOutput(IN[2].vertex,float2(0,0),half3(0,0,1)));
            }
